  ...
  <div class="login-logo">
    <div class="row">
      <div class="col-8 offset-2">
        <img style="width: 50%; height: auto;" src="<?php echo base_url('assets/media') ?>/logos/logo.png">
      </div>
    </div>
    <div class="row">
      <div class="col-12 ">
        <div>SIEJARAK<b style="letter-spacing:1.5px;"><br/><h4>Sistem Informasi Penentu Jarak Terdekat Antar Kota</h4></b></div>
      </div>
    </div>
  </div>
  <!-- /.login-logo -->
