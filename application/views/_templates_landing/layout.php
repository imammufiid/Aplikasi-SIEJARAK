...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title><?php echo $_settings->setting_web_name ?></title>
		...
		<style type="text/css">
			...
			#bodyku{
				background-image: url("../../../assets/media/bg/bg-map.jpg");
			}
		</style>
	...
	<body class="kt-page--fluid kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading" id="bodyku">
						...
						<div class="kt-container">
							...
							<div class="kt-header__brand" id="kt_header_brand">
								<div class="kt-header__brand-logo">
									...
									<span class="ml-3"><h3 class="m-0 text-white">SIEJARAK App</h3></span>
							</div>
